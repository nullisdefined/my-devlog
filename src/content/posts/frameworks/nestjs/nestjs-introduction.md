...
date: 2025-08-24
tags: ["NestJS", "NestCLI", "Frameworks"]
...
> [!HINT] 더 *엄격한 기능* 세트를 가진 새 TypeScript 프로젝트를 생성하려면 `nest new` 명령에 `--strict` 플래그를 전달하세요.
...
> [!HINT] git 히스토리 없이 저장소를 클론하려면 *degit*을 사용할 수 있습니다.
